...
## Correção de Renderização de PDF (08/12/2025)

- [x] Investigar como PDFs estão sendo renderizados no modal
- [x] Implementar visualizador de PDF adequado (iframe nativo)
- [x] Testar renderização de PDF do Contrato Why Consulting v2
- [x] Verificar se todos os PDFs renderizam corretamente
- [x] Criar checkpoint final com correção implementada
